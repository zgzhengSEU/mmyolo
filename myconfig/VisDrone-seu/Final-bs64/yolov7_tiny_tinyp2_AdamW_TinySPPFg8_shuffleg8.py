...
# ======================== wandb & run ==============================
TAGS = ["SEU", "load", "tinyp2","AdamW", "TinySPPF", 'TinyShuffleELAN']
GROUP_NAME = "yolov7_tiny-final-bs64"
ALGO_NAME = "yolov7_tiny_tinyp2_AdamW_TinySPPFg8_TinyShuffleELANg8"
...
model = dict(
    ...
    neck=dict(
        ...
        block_cfg=dict(
            _delete_=True, type='TinyShuffleDownSampleBlock', middle_ratio=0.25, shuffle_groups=shuffle_groups),
        act_cfg=dict(type='LeakyReLU', negative_slope=0.1),
