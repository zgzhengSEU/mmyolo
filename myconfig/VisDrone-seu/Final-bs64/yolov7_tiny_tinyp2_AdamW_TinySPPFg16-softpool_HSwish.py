...
# ======================== wandb & run ==============================
TAGS = ["SEU", "load", "tinyp2","AdamW", "TinySPPF", "HSwish"]
GROUP_NAME = "yolov7_tiny-final-bs64"
ALGO_NAME = "yolov7_tiny_tinyp2_AdamW_TinySPPFg8-softpool_HSwish"
...
model = dict(
    ...
    neck=dict(
        ...
        use_SPPF_mode=True,
        use_softpool=True,
        sppf_groups=16, # 1: 7.779G 6.128M; 4: 7.582G 5.636M; 8: 7.549G 5.554M; 16: 7.533G 5.513M; 32: 7.525G 5.439M
