...
model = dict(
    ...
    distiller=dict(
        ...
        student_recorders=dict(
            fpn0=dict(type='ModuleOutputs', source='neck.0.bottom_up_layers.0.final_conv.conv'),
            fpn1=dict(type='ModuleOutputs', source='neck.0.bottom_up_layers.1.final_conv.conv'),
            fpn2=dict(type='ModuleOutputs', source='neck.0.bottom_up_layers.2.final_conv.conv'),
            fpn3=dict(type='ModuleOutputs', source='neck.0.bottom_up_layers.3.final_conv.conv')),
