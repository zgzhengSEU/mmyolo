_base_ = './density_yolov7_l_origin.py'

# ======================== wandb & run ==============================
TAGS = ["SEU", "load", "yolov7_tiny", "AdamW", "density"]
GROUP_NAME = "density_yolov7_tiny-final-bs64"
ALGO_NAME = "density_yolov7_tiny_AdamW"
DATASET_NAME = "Density_VisDrone"
...
density_VisDrone_anchors_v5_k_means = [
    [(3, 6), (8, 8), (9, 17)], 
    [(19, 13), (20, 31), (44, 25)], 
    [(46, 67), (95, 86), (193, 215)]]

anchors = density_VisDrone_anchors_v5_k_means # 修改anchor
