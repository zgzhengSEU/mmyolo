...
# -----data related-----
data_root = 'data/DensVisDrone/'  # Root path of data
CLASSES = ("pedestrian", "people", "bicycle", "car", "van", "truck", "tricycle", "awning-tricycle", "bus", "motor")
METAINFO = {'classes': CLASSES}
# Path of train annotation file
train_ann_file = 'annotations/denstrain.json'
train_data_prefix = 'images/crop_and_origin_train/'  # Prefix of train image path
