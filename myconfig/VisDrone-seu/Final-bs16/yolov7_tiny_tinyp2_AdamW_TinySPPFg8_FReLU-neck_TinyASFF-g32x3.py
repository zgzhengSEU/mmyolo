...
# ======================== wandb & run ==============================
TAGS = ["SEU", "load", "tinyp2","AdamW", "TinySPPF", "FReLU", "TinyASFF"]
GROUP_NAME = "yolov7_tiny-final-bs16"
ALGO_NAME = "yolov7_tiny_tinyp2_AdamW_TinySPPFg8_FReLU-neck_TinyASFF-g32x3"
...
model = dict(
    ...
    neck=[
        dict(
            ...
            block_cfg=dict(
                type='TinyDownSampleBlock', middle_ratio=0.25, use_FReLU=neck_FReLU),
            act_cfg=dict(type='LeakyReLU', negative_slope=0.1),
