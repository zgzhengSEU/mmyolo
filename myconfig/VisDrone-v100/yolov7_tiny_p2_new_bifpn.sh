...
CONFIG_FILE="myconfig/VisDrone-v100/yolov7_tiny_p2_new_bifpn.py"

name="yolov7_tiny-"
Wandb_NameALL="visualizer.vis_backends.1.init_kwargs.name=${name}"

tags="['v100','yolov7_tiny','300e','amp','p2','v5-kmeans','cbam1234','Adamw','bifpn4']"
...
CUDA_VISIBLE_DEVICES=0 python tools/train.py $CONFIG_FILE --amp --cfg-options ${Wandb_NameALL}32-v100-v5kmeans-p2-cbam1234-Adamw-bifpn4 ${Wandb_TagsALL}
