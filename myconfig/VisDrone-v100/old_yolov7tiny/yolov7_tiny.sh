...
CONFIG_FILE="myconfig/VisDrone-v100/yolov7_tiny.py"
...
CUDA_VISIBLE_DEVICES=2 python tools/train.py $CONFIG_FILE --amp --cfg-options ${Wandb_NameALL}64-v100 ${Wandb_TagsALL}