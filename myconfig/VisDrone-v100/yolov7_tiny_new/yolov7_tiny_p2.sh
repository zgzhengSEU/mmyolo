...
CONFIG_FILE="myconfig/VisDrone-v100/yolov7_tiny_new/yolov7_tiny_p2.py"
...
CUDA_VISIBLE_DEVICES=2 python tools/train.py $CONFIG_FILE --amp --cfg-options ${Wandb_NameALL}32-V100-v5kmeans-p2-autoSGD ${Wandb_TagsALL}