    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-amp-64-t4-adamw-DEanchors',
                tags=[
                    't4', 'yolov7_tiny', '300e', 'amp', 'adamw', 'DEanchors'
                ]))
    ],
    name='visualizer')
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230223_074920'
work_dir = 'runs/VisDrone/yolov7_tiny/20230223_074920'
