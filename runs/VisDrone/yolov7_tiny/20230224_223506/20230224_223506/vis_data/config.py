    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-64-v100-adamw-v5kmeans-p2-cbam1234',
                tags=[
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230224_223506'
work_dir = 'runs/VisDrone/yolov7_tiny/20230224_223506'
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='AdamW', lr=0.05, weight_decay=0.05),
    paramwise_cfg=dict(
