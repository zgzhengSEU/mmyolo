    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-amp-64-t4-adamw-DEanchors-cbam34',
                tags=[
                    't4', 'yolov7_tiny', '300e', 'amp', 'adamw', 'cbam34',
                    'DEanchors'
                ]))
    ],
    name='visualizer')
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230223_091743'
work_dir = 'runs/VisDrone/yolov7_tiny/20230223_091743'
...
DE_anchors = [[(3, 4), (4, 8), (7, 6)], [(7, 12), (14, 9), (11, 18)],
              [(25, 14), (21, 27), (44, 35)]]
anchors = [[(3, 4), (4, 8), (7, 6)], [(7, 12), (14, 9), (11, 18)],
           [(25, 14), (21, 27), (44, 35)]]
base_lr = 0.01
max_epochs = 300
num_epoch_stage2 = 30
...
model = dict(
    ...
    backbone=dict(
        ...
        plugins=[
            dict(
                cfg=dict(type='CBAMLayer'), stages=(False, False, True, True))
        ]),
    neck=dict(
        type='YOLOv7PAFPN',
    ...
    bbox_head=dict(
        ...
        prior_generator=dict(
            ...
            base_sizes=[[(3, 4), (4, 8), (7, 6)], [(7, 12), (14, 9), (11, 18)],
                        [(25, 14), (21, 27), (44, 35)]],
            strides=[8, 16, 32]),
        loss_cls=dict(
