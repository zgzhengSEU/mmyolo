    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-32-T4-v5kmeans-p2-obj_level_weights',
                tags=[
                    'v100', 'yolov7_tiny', '300e', 'amp', 'p2', 'v5-kmeans',
                    'obj_level_weights'
                ]))
    ],
    name='visualizer')
...
prior_match_thr = 4.0
obj_level_weights = [4.0, 1.0, 0.25, 0.1]
lr_factor = 0.01
weight_decay = 0.0005
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(1, 2, 3, 4),
        plugins=[
            dict(cfg=dict(type='CBAM'), stages=(False, False, False, False))
        ]),
    neck=dict(
        type='YOLOv7PAFPN',
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230225_074436'
work_dir = 'runs/VisDrone/yolov7_tiny/20230225_074436'
