    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-amp-64-v100-adamw-kmeans-bifpn',
                tags=[
                    'v100', 'yolov7_tiny', '300e', 'amp', 'adamw', 'bifpn',
                    'kmeans'
                ]))
    ],
    name='visualizer')
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230223_162306'
work_dir = 'runs/VisDrone/yolov7_tiny/20230223_162306'
...
DE_anchors = [[(3, 4), (4, 8), (7, 6)], [(7, 12), (14, 9), (11, 18)],
              [(25, 14), (21, 27), (44, 35)]]
anchors = [[(3, 5), (4, 9), (8, 6)], [(8, 14), (16, 9), (15, 18)],
           [(31, 17), (22, 35), (53, 38)]]
base_lr = 0.01
max_epochs = 300
num_epoch_stage2 = 30
...
model = dict(
    ...
    bbox_head=dict(
        ...
        prior_generator=dict(
            ...
            base_sizes=[[(3, 5), (4, 9), (8, 6)], [(8, 14), (16, 9), (15, 18)],
                        [(31, 17), (22, 35), (53, 38)]],
            strides=[8, 16, 32]),
        loss_cls=dict(
