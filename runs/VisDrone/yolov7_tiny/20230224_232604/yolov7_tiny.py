    ...
    vis_backends=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='VisDrone',
                group='yolov7_tiny',
                name='yolov7_tiny-32-v100',
                tags=['v100', 'yolov7_tiny', '300e', 'amp']))
    ],
    name='visualizer')
...
Wandb_init_kwargs = dict(
    ...
    name='yolov7_tiny',
    tags=['v100', 'yolov7_tiny', '300e'])
NOW_TIME = '20230224_232604'
work_dir = 'runs/VisDrone/yolov7_tiny/20230224_232604'
VisDrone_anchors_v5_k_means = [[(3, 5), (4, 9), (8, 6)],
                               [(8, 14), (16, 9), (15, 18)],
                               [(31, 17), (22, 35), (53, 38)]]
DE_anchors = [[(3, 4), (4, 8), (7, 6)], [(7, 12), (14, 9), (11, 18)],
              [(25, 14), (21, 27), (44, 35)]]
origin_anchors = [[(12, 16), (19, 36), (40, 28)],
                  [(36, 75), (76, 55), (72, 146)],
                  [(142, 110), (192, 243), (459, 401)]]
launcher = 'none'
